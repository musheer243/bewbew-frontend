...
const Settings = () => {
  ...
  return (
    <div className="settings-container">
      <h2>Settings</h2>
         {/* Optionally display user info for debugging or confirmation */}
   {user && (
      ...
      <h1 className="settings-title">Your Account</h1>
        ...
        <li className="settings-item" data-tooltip="The Posts you Liked"  onClick={() => navigate("/post-activity/my-LikedPosts")}><RiHeartsLine className="icon" size={27}/> My Liked </li>
        <li className="settings-item" data-tooltip="Saved Post"  onClick={() => navigate("/post-activity/my-SavedPosts")}><BiBookmarkHeart className="icon" size={27}/> My Saved </li>
        <li className="settings-item" data-tooltip="Manage Schudle Post"  onClick={() => navigate("/post-activity/my-ScheduledPosts")}><LuCalendarHeart className="icon" size={27}/> My Schedule Post </li>  

        {/* <h1 className="settings-title" style={{marginTop:'30px'}}>Post Activity</h1>
        <li className="settings-item" data-tooltip="View your post activity" onClick={() => navigate("/post-activity")}>
                <LuCalendarHeart className="icon" size={27}/> Post Activity
        </li> */}
